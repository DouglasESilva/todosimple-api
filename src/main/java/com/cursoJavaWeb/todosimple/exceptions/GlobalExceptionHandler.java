...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler implements AuthenticationFailureHandler {
    ...
    // Erro 409 criado usuario duas vezes
    ...
    // 422 Unprocessable Entity (WebDAV) vazio no argumento
    ...
    public ResponseEntity<Object> handleConstraintViolationException (ConstraintViolationException constraintViolationException, WebRequest request) {
        log.error("Faile to validate element ", constraintViolationException);
